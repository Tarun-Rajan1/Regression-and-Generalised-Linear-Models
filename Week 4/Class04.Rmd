...
#Regress re78 on all other variables and display the summary output
...
xy <- as.data.frame(xy)
colnames(xy) <- c("x", "y")
# OLS, fit a linear model y based on x and one linear model of x based on y
